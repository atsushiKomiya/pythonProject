...
if __name__ == '__main__':
    ...
    try:
        ...
        for i in range(ARRIVAL_GET_COUNT):
            ...
            # メイン画像取得
            try:
                main_img_elm = driver.find_element_by_xpath('//div/h2/img')
                main_img_elm.click()
                time.sleep(1)
                main_img_elm_data = main_img_elm.find_element_by_id("lightbox-image")
                main_img_url = main_img_elm_data.get_attribute("src")
                ...
                main_img_elm.find_element_by_id("lightbox-secNav-btnClose").click()
